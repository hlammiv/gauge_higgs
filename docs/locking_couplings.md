...
### Remaining
- **2I (spin-6, Young rows {12})**: blocked — the single-row Young symmetrizer enumerates
  12! permutations. Needs a direct symmetric-rep basis in `GeneralRep` (no n! enumeration).
